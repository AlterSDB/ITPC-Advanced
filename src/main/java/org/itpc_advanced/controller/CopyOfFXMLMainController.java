...
public class CopyOfFXMLMainController {
	...
	@FXML public Text                          subStatusText;
	@FXML
	public Text                          statusText;
	@FXML public AnchorPane                    spinnerPane;
	@FXML public Circle                        innerCircle;
	@FXML public Circle                        middleCircle;
	@FXML public Circle                        outerCircle;
	      private   Settings                      settings;
	      private   DeviceScanner                 deviceScanner;
	      private   List<Animation>               loadingAnimations;
	      private static CopyOfFXMLMainController       instance;

	public CopyOfFXMLMainController() {
		instance = this;
	}

	public static CopyOfFXMLMainController getInstance() {
		return instance;
	}
